    ...
    display() {
        if (this.state.fetching === true) {
            if (this.state.fetched === true) {
                return (
                    <FadeIn>
                        <div className="row mx-auto my-auto">
                            ...
                            <div className="col mx-auto my-auto" style={{ textAlign: "center" }}>
                                It's a
                                <div className="heading">{this.state.result}</div>
                                <hr />
                ...
                return (
                    <div className="row mx-auto my-auto" style={{ textAlign: "center" }}>
                    ...
                    <div className="container">
                        <Form onSubmit={this.onSubmit}>
                            <Form.Group controlId="formBasicEmail">
                                ...
                                <Form.Text className="text-muted"> We will fetch it for you from the internet</Form.Text>
                            </Form.Group>
